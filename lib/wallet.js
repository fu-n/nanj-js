 ...
 * Get NANJ balance
 */ 
Wallet.prototype.walletCheck = async function (address) {
    let response = {}
 ...
 */ 
Wallet.prototype.relayNonce = async function (address) {
 ...
 */ 
Wallet.prototype.createWallet = async function (mnemonic, password) {
 ...
 * API import wallet
 */ 
Wallet.prototype.importWallet = async function (jsonKeystore, password) {
