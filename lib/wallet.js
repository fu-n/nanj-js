...
/**
 * API generate NANJ Address
 */ 
exports.generateAddress= async function(address, privateKey) {
    if (typeof address == 'undefined'|| typeof privateKey == 'undefined') {
        let valid = {}
        valid.status = 422
        valid.message = "Address and Private Key is required."
    ...
    return await generateData.generateAddress(address, privateKey)
}

/**
 * API generate QRCode from address wallet
 */ 
exports.QRCodeAddress = function(address='') {
    if (address.length) {
