 ...
 */ 
Transaction.prototype.getRelayerTxHash = async function (from, to, amount, message) {
 ...
 */ 
Transaction.prototype.getHashSign = async function (data, hash, privKey, destinationAddress) {
 ...
 * API send send 
 */ 
Transaction.prototype.send = async function (hashSign) {
